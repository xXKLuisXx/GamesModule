function CPreloader() {
    ...
    this._init = function () {
        ...
        s_oSpriteLibrary.addSprite("progress_bar", "././img/spritesSlotMachine/progress_bar.png");
        s_oSpriteLibrary.addSprite("200x200", "././img/spritesSlotMachine/200x200.jpg");
        s_oSpriteLibrary.addSprite("but_start", "././img/spritesSlotMachine/but_start.png");
